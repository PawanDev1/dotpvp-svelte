...
<div class="relative h-[50%] max-h-[340px] p-[5px]">
	<img
	...
	<div
		...
		class="flex h-[47px] items-center justify-between bg-[#33203A] px-5 py-3 pr-[17px]"
	>
		<h2 class="flex items-center gap-2 font-bold text-[#F6F6F6]">
			Stats and Feed
			<div
		...
		<div class="flex items-end gap-2 text-sm">
			{#each TABS as tab}
				...
				<button
					...
					class="relative flex gap-1 px-[12px] py-[4px] text-xs capitalize {isActive
						? 'rounded-[2px] border border-[#FFEF00] bg-[linear-gradient(34deg,rgba(32,19,53,0.13)_14.13%,rgba(85,42,152,0.13)_47.4%,rgba(208,188,245,0.13)_73.78%)] font-bold tracking-normal text-[#FFEF00] shadow-[0_0_8px_0_rgba(255,239,0,0.50)]'
						: 'text-[#D1D0D0]'}"
				>
					{tab.name}
				</button>
